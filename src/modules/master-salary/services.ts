...
export const masterSalaryApi = {
  skintones: {
    ...
    create: async (data: SkintoneDto) =>
      (await axiosClient.post<{ data: SkintoneDto }>('/master-salary/skintone', withUserId(data)))
        .data.data,
  ...
  castes: {
    ...
    create: async (data: CasteDto) =>
      (await axiosClient.post<{ data: CasteDto }>('/master-salary/caste', withUserId(data))).data
        .data,
    update: async (id: number, data: Partial<CasteDto>) =>
      (await axiosClient.put<{ data: CasteDto }>(`/master-salary/caste/${id}`, withUserId(data)))
        .data.data,
  ...
  religions: {
    ...
    create: async (data: ReligionDto) =>
      (await axiosClient.post<{ data: ReligionDto }>('/master-salary/religion', withUserId(data)))
        .data.data,
  ...
  scheduleTypes: {
    list: async () =>
      (await axiosClient.get<{ data: ScheduleTypeDto[] }>('/master-salary/schedule-type')).data
        .data,
  ...
  natureOfWorks: {
    ...
    create: async (data: NatureOfWorkDto) =>
      (await axiosClient.post<{ data: NatureOfWorkDto }>('/nature-of-work', withUserId(data))).data
        .data,
    update: async (id: number, data: Partial<NatureOfWorkDto>) =>
      (await axiosClient.put<{ data: NatureOfWorkDto }>(`/nature-of-work/${id}`, withUserId(data)))
        .data.data,
    remove: async (id: number) => axiosClient.delete(`/nature-of-work/${id}`),
  },
  salItSections: {
    list: async () =>
      (await axiosClient.get<{ data: SalItSectionDto[] }>('/master-salary/sal-it-section')).data
        .data,
  ...
  shiftTimings: {
    list: async (params?: Record<string, any>) =>
      (
        ...
        }>('/master-salary/sal-shift-timing', { params })
      ).data.data,
    create: async (data: any) =>
      (await axiosClient.post<{ data: any }>('/master-salary/sal-shift-timing', withUserId(data)))
        .data.data,
